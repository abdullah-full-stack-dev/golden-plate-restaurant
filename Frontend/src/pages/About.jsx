  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <title>
          About Us | The Golden Plate Restaurant
        </title>

        <meta
          name="description"
          content="Learn about The Golden Plate, a premium fine dining restaurant offering delicious cuisine and luxury ambience."
        />
